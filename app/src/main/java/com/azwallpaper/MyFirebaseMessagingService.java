...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    String notification_id = "", noti_uid = "", msg = "", imgurl = "", type = "", sid = "";
    ...
    private void sendNotification(String messageBody) {
        try {
            ...
            intent = new Intent(this, AlbumViewActivity.class);
    ...
    private void sendNotificationData(Map<String, String> data) {
        try {
            ...
            if (data != null && data.size() > 0) {
                ...
                if ( msg != null && imgurl != null) {
                    App.showLog(TAG, "--msg--" + msg);
                    App.showLog(TAG, "--imgurl--" + imgurl);


                    Post post = new Post();
                    post.lat = "" + msg;
                    post.lon = "" + imgurl;
                    App.getDatabaseHelper().addPost(post);
